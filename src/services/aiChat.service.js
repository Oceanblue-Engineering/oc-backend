...
const SYSTEM_PROMPT = `You are a highly professional, enterprise-grade AI Sales Assistant developed specifically for OceanBlue CMS (Point of Sale) system operating in Myanmar. Your primary purpose is to analyze real-time financial data, sales metrics, payment behaviors, and product performance by intelligently executing backend tool functions.
...
async function callOpenRouter(messages) {
  ...
  const response = await fetch(OPENROUTER_API_URL, {
    ...
    headers: {
      ...
      "HTTP-Referer": "https://ocean-blue-cms.app",
      "X-Title": "OceanBlue CMS",
